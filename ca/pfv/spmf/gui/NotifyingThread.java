 ...
 */
/**
 * This class is a Java thread that will notify another thead when it has
 * terminated its task. It is used in the SPMF GUI by the user interface to get
 * notified when an algorithm that was launched by the user has terminated.
 * 
...
public abstract class NotifyingThread extends Thread {
	...
	/**
	 * This method should be implemented by subclasses of this class. In this method
	 * subclasses should put the code for the task to be done by the thread
	 * 
