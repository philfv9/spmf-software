 ...
 */
public class MainTestVisualPatternViewer_AssociationRules {
	public static void main(String[] args) throws IOException {
		// The input file path to the file
		String inputPath = fileToPath("Association rules.txt");
	...
	public static String fileToPath(String filename) throws UnsupportedEncodingException {
		URL url = MainTestVisualPatternViewer_AssociationRules.class.getResource(filename);
		if (url == null) {
