 ...
 */
public class MainTestVisualPatternViewer_MAPD {
	public static void main(String[] args) throws IOException {
		// The input file path to the file
		String inputPath = fileToPath("mapd.txt");
		
		// Create the tool for viewing rules.
        VisualPatternViewer viewer = new VisualPatternViewer(true, inputPath, PatternType.STRING_SEQUENTIAL_PATTERNS_NO_GAP);
	...
	public static String fileToPath(String filename) throws UnsupportedEncodingException {
		URL url = MainTestVisualPatternViewer_MAPD.class.getResource(filename);
		if (url == null) {
