 ...
 */
public class MainTestVisualPatternViewer_UncertainItemsets {
	public static void main(String[] args) throws IOException {
		// The input file path to the file
		String inputPath = fileToPath("uncertain_itemsets.txt");
		
		// Create the tool for viewing rules.
        VisualPatternViewer viewer = new VisualPatternViewer(true, inputPath, PatternType.UNCERTAIN_ITEMSETS);
	...
	public static String fileToPath(String filename) throws UnsupportedEncodingException {
		URL url = MainTestVisualPatternViewer_UncertainItemsets.class.getResource(filename);
		if (url == null) {
