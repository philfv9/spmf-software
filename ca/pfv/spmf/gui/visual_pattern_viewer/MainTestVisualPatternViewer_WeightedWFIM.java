 ...
 */
public class MainTestVisualPatternViewer_WeightedWFIM {
	public static void main(String[] args) throws IOException {
		// The input file path to the file
		String inputPath = fileToPath("weighted_WFIM.txt");
	...
	public static String fileToPath(String filename) throws UnsupportedEncodingException {
		URL url = MainTestVisualPatternViewer_WeightedWFIM.class.getResource(filename);
		if (url == null) {
