 ...
 */
public class MainTestVisualPatternViewer_HUAssociationRules {
	public static void main(String[] args) throws IOException {
		// The input file path to the file
		String inputPath = fileToPath("huassociationrules.txt");
	...
	public static String fileToPath(String filename) throws UnsupportedEncodingException {
		URL url = MainTestVisualPatternViewer_HUAssociationRules.class.getResource(filename);
		if (url == null) {
