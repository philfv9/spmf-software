 ...
 */
public class MainTestVisualPatternViewer_NegativeAssociationRules {
	public static void main(String[] args) throws IOException {
		// The input file path to the file
		String inputPath = fileToPath("negative_rules.txt");
		
		// Create the tool for viewing rules.
        VisualPatternViewer viewer = new VisualPatternViewer(true, inputPath, PatternType.ASSOCIATION_RULES);
	...
	public static String fileToPath(String filename) throws UnsupportedEncodingException {
		URL url = MainTestVisualPatternViewer_NegativeAssociationRules.class.getResource(filename);
		if (url == null) {
