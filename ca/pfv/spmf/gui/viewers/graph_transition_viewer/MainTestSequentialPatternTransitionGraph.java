 ...
 **/
public class MainTestSequentialPatternTransitionGraph {

	public static void main(String[] args) throws Exception {

		// The path to a file containing sequential patterns
		// in the standard SPMF output format
		String inputFile = fileToPath("Sequential patterns.txt");

		// Launch the Transition Graph Viewer in standalone mode
		boolean runAsStandaloneProgram = true;
		TransitionGraphViewer viewer = new TransitionGraphViewer(inputFile, PatternType.SEQUENTIAL_PATTERNS,
	...
	public static String fileToPath(String filename) throws UnsupportedEncodingException {
		URL url = MainTestSequentialPatternTransitionGraph.class.getResource(filename);
