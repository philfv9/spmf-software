...
/**
 * This class represent an association rule used by the Agrawal algorithm such
 * that it uses the lift mesure. * It is based on: Agrawal & al. 1994, IBM
 * Research Report RJ9839, June 1994.
 * 
...
public class AssocRule extends Rule {
	 ...
	 * @param transactionCount  the absolute support of the rule (integer)
	 * @param confidence        the confidence of the rule
	 * @param lift              the lift of the rule
	 */
	public AssocRule(int[] itemset1, int[] itemset2, int supportAntecedent, int transactionCount, double confidence,
			double lift) {
