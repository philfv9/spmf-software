...
public class AssocRules {
	...
	public void printRules(int databaseSize) {
		...
		for (AssocRule rule : rules) {
			...
			System.out.print("support :  " + rule.getRelativeSupport(databaseSize) + " (" + rule.getAbsoluteSupport()
					+ "/" + databaseSize + ") ");
	...
	/**
	 * Print all the rules in this list to System.out, and include information about
	 * the lift measure.
	 * 
	 * @param databaseSize the number of transactions in the transaction database
	 *                     where the rules were found
	 ...
	 * 
	 * @param databaseSize the number of transactions in the database where the
	 *                     rules were found.
	 * @return a string
	 */
