 ...
 * as a list of arrays of integers. It can read a transaction database directly from a file. 
...
public class TransactionDatabase {
	...
	private final List<int[]> transactions = new ArrayList<int[]>();
	...
	private void addTransaction(String itemsString[]) {
		...
		// Because the items may not be sorted in a transaction, we sort them by lexicographical order
		Arrays.sort(itemset);
	...
	public void printDatabase() {
		...
		for (int[] itemset : transactions) { // pour chaque objet
