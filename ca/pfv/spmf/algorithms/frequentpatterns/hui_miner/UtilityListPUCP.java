...
/**
 * This class represents a UtilityList as used by the PUCPMiner algorithm.
 *
 * @see AlgoPUCPMiner
 * @see Element
 */
public class UtilityListPUCP {
	Integer item; // the item
	long sumIutils = 0; // the sum of item utilities
	long sumRutils = 0; // the sum of remaining utilities
	long sumIutils_ZR = 0; // the sum of item utilities its remaining utility is zero
	 ...
	 */
	public UtilityListPUCP(Integer item) {
		this.item = item;
	}
