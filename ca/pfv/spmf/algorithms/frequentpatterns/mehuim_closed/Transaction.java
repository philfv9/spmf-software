...
public class Transaction {
    ...
    public Transaction SetTransaction(int[] items, int[] utilities, int transactionUtility, int[][] originalTransactions) {
        this.items = items;
        this.utilities = utilities;
        this.transactionUtility = transactionUtility;
        this.offset = 0;
    ...
    public Transaction SetTransaction(Transaction transaction, int offsetE) {
        // copy items and utilities from the original transaction
        this.items = transaction.getItems();
        this.utilities = transaction.getUtilities();
