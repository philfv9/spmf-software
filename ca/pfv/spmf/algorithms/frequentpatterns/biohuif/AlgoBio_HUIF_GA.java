...
/**
 * This is an implementation of the "Bio_HUIF_GA Algorithm" for High-Utility
 * Itemsets Mining as described in the paper : <br/>
 * <br/>
 * 
 * Wei Song, Chaomin Huang. Mining High Utility Itemsets Using Bio-Inspired
 * Algorithms: A Diverse Optimal Value Framework. IEEE Access, 2018, 6(1):
 * 19568-19582.
 * 
 *
...
public class AlgoBio_HUIF_GA {
	 ...
	 * 
	 * @param temp1      the number of chromosome to crossover
	 * @param temp2      the number of chromosome to crossover
	 * @param minUtility
	 */
	...
	/**
	 * 
	 * @param pMax             maximum mutation rate
	 * @param pMin             minimum mutation rate
	...
	private List<ChroNode> rankedMutation(double pMax, double pMin, int currentIteration, int minUtility) {
		...
		for (int i = 0; i < pop_size; i++) {
			// calculate pm
			pm = (pMax - (pMax - pMin) * currentIteration / max_iter) * record.get(i) / subPopulation.size();
			rankNum = Math.random();
