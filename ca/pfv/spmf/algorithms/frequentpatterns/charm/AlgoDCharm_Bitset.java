...
public class AlgoDCharm_Bitset extends AlgoCharm_Bitset{
	...
	public void printStats() {
		System.out.println("=============  dCharm vALTERNATE-Bitset v2.65 - STATS =============");
	...
	void save(int[] prefix, int[] suffix, BitSetSupport tidset) throws IOException {
		...
		int hashcode = hash.hashCode(Integer.hashCode(tidset.support));
		...
		if (!hash.containsSupersetOf(itemset, hashcode)) {
			...
			if (writer == null) { 
				...
				// I REMOVED THE FOLLOWING LINES BECAUSE IT DOES NOT WORK FOR A DIFFSET:
				// IF WE WANT TO IMPLEMENT THIS WE WOULD HAVE TO RECOVER THE TIDSET.
