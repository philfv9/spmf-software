...
public abstract class DescriptionOfAlgorithm {
	...
	/** get the category of this algorithm (e.g. "sequential rule mining" as presented to the user */
	...
	/** get the algorithm type (used internally) */
	...
	/**
	 * Method to transform a string to a long
	 * 
	 * @param value
	 *            a string
	 * @return a long
	 */
	protected static long getParamAsLong(String value) {
	...
	/**
	 * Get the number of mandatory parameters
	 * @return the number
	 */
	public int getNumberOfMandatoryParameters() {
		int count = 0;
		for(DescriptionOfParameter parameter : getParametersDescription()) {
