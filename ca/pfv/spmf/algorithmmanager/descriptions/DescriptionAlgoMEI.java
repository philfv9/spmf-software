...
/**
 * This class describes the MEI algorithm parameters.
 * It is designed to be used by the graphical and command line interface.
 * 
 * @see AlgoMEI
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoMEI extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoMEI() {
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/MEI.php";
	}
