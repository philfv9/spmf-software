 ...
 */
public class DescriptionAlgoViewerFrequentItemsetsMultiThresh extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoViewerFrequentItemsetsMultiThresh(){
	}

	@Override
	public String getName() {
		return "Visualize_Frequent_itemsets_with_multi_thresholds";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/View_frequent_itemsets_multi_thres.php";
	}
	...
	public String[] getInputFileTypes() {
		return new String[]{"Frequent itemsets with multiple thresholds"};
	}
