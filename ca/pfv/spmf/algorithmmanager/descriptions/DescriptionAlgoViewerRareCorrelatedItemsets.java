 ...
 */
public class DescriptionAlgoViewerRareCorrelatedItemsets extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoViewerRareCorrelatedItemsets(){
	}

	@Override
	public String getName() {
		return "Visualize_Rare_correlated_itemsets";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/Visualize_Rare_correlated_itemsets.php";
	}
	...
	public String[] getInputFileTypes() {
		return new String[]{"Rare correlated itemsets"};
	}
