...
/**
 * This class describes the D2HUP algorithm parameters. It is designed to be
 * used by the graphical and command line interface.
 * 
 * @see AlgoApriori
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoD2HUP extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoD2HUP() {
	}
