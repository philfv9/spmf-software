...
import ca.pfv.spmf.algorithms.frequentpatterns.witfwi.AlgoWIT_FWI_MOD;
...
/**
 * This class describes the WIT-FWI-MODIFY algorithm parameters.
 * It is designed to be used by the graphical and command line interface.
 *
 * @see AlgoWIT_FWI_MOD
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoWIT_FWI_MOD extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoWIT_FWI_MOD(){
	}
	...
	public void runAlgorithm(String[] parameters, String inputFile, String outputFile) throws IOException {
		...
		// Applying the WIT-FWI-MODIFY algorithm
		AlgoWIT_FWI_MOD algorithm = new AlgoWIT_FWI_MOD();
