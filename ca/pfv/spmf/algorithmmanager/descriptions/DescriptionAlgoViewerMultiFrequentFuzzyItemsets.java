 ...
 */
/**
 * This class describes the algorithm to visualize multi fuzzy frequent itemsets.
 * 
 * @see VisualPatternViewer
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoViewerMultiFrequentFuzzyItemsets extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoViewerMultiFrequentFuzzyItemsets(){
	}

	@Override
	public String getName() {
		return "Visualize_Multi_frequent_fuzzy_itemsets";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/Visualize_Multi_frequent_fuzzy_itemsets.php";
	}
	...
	public String[] getInputFileTypes() {
		return new String[]{"Multiple Frequent fuzzy itemsets"};
	}
