...
import ca.pfv.spmf.algorithms.associationrules.TopKRules_and_TNR.AlgoETARM;
...
/**
 * This class describes parameters of the ETARM algorithm for generating Top-K association rules. 
 * It is designed to be used by the graphical and command line interface.
 * 
 * @see AlgoETARM  
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoETARM extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoETARM(){
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/ETARMtopk.php";
	}
