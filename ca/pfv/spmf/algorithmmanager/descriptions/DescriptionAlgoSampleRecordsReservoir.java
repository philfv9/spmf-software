...
/**
 * This class describes the algorithm to sample records from a file using
 * reservoir sampling. This is a memory-efficient algorithm suitable for
 * very large files.
 ...
 */
public class DescriptionAlgoSampleRecordsReservoir extends DescriptionOfAlgorithm {

    /**
     * Default constructor
     */
    public DescriptionAlgoSampleRecordsReservoir() {
    }

    @Override
    public String getName() {
        return "Sample_Records_Reservoir";
    }
    ...
    public void runAlgorithm(String[] parameters, String inputFile, String outputFile) 
        ...
        if (sampleCount <= 0) {
            throw new IllegalArgumentException(
                "Sample count must be greater than 0, got: " + sampleCount);
        }
        
        // Create an instance of the algorithm
        AlgoSampleRecords algorithm = new AlgoSampleRecords();
        
        // Run the algorithm using reservoir sampling
        algorithm.runAlgorithmReservoir(inputFile, outputFile, sampleCount);
...
//        return "Samples records from a file using reservoir sampling algorithm. "
//                + "This is memory-efficient and suitable for very large files "
//                + "as it does not require loading all records into memory.";
//    }
}