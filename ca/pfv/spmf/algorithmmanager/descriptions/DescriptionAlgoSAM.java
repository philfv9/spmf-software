...
*/
/**
 * This class describes the SAM algorithm parameters. It is designed to be
 * used by the graphical and command line interface.
 * 
 * @see AlgoSAM
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoSAM extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoSAM() {
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/SAM_itemset.php";
	}
