 ...
 */
/**
 * This class describes the Visualize trending HUIs algorithm to visualize locally trending high utility itemsets.
 * 
 * @see VisualPatternViewer
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoViewerTrendingHUIs extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoViewerTrendingHUIs(){
	}

	@Override
	public String getName() {
		return "Visualize_locally_trending_HUIs";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/Visualize_locally_trending_HUIs.php";
	}
	...
	public String[] getInputFileTypes() {
		return new String[]{"Locally trending high-utility itemsets"};
	}
