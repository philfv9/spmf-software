...
/**
 * This class describes the AprioriFast algorithm parameters. 
 * It is designed to be used by the graphical and command line interface.
 * 
 * @see AlgoAprioriFAST
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoAprioriFast extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoAprioriFast(){
	}
	...
	public void runAlgorithm(String[] parameters, String inputFile, String outputFile) throws IOException {
		...
		AlgoAprioriFAST algorithm = new AlgoAprioriFAST();
		
		if (parameters.length >=2 && "".equals(parameters[1]) == false) {
			algorithm.setMaximumPatternLength(getParamAsInteger(parameters[1]));
		}
		
		algorithm.runAlgorithm(minsup, inputFile, outputFile, 30);
