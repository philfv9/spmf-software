...
/**
 * This class describes the MERIT+ algorithm parameters. 
 * It is designed to be used by the graphical and command line interface.
 * 
 * @see AlgoMERIT
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoMERIT extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoMERIT(){
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/MERITPlus.php";
	}
