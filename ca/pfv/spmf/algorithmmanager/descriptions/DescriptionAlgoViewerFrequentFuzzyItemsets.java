 ...
 */
public class DescriptionAlgoViewerFrequentFuzzyItemsets extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoViewerFrequentFuzzyItemsets(){
	}

	@Override
	public String getName() {
		return "Visualize_Frequent_fuzzy_itemsets";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/Visualize_Frequent_fuzzy_itemsets.php";
	}
	...
	public String[] getInputFileTypes() {
		return new String[]{"Frequent fuzzy itemsets"};
	}
