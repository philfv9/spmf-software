...
import ca.pfv.spmf.algorithms.associationrules.TopKRules_and_TNR.AlgoFTARM;
...
/**
 * This class describes parameters of the FTARM algorithm for generating Top-K association rules. 
 * It is designed to be used by the graphical and command line interface.
 * 
 * @see AlgoFTARM
 * @author Philippe Fournier-Viger   
 */
public class DescriptionAlgoFTARM extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoFTARM(){
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/topkFTARM.php";
	}
