 ...
 */
/**
 * This class describes the algorithm to visualize peak high utility itemsets.
 * 
 * @see VisualPatternViewer
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoViewerLocalHighUtilityItemsets extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoViewerLocalHighUtilityItemsets(){
	}

	@Override
	public String getName() {
		return "Visualize_Local_high_Utility_itemsets";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/Visualize_localHUIs.php";
	}
	...
	public String[] getInputFileTypes() {
		return new String[]{"Local high-utility itemsets"};
	}
