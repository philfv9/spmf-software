 ...
 */
/**
 * This class describes the algorithm to visualize productive periodic frequent itemsets.
 * 
 * @see VisualPatternViewer
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoViewerProdPeriodicFrequentItemsets extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoViewerProdPeriodicFrequentItemsets(){
	}

	@Override
	public String getName() {
		return "Visualize_Productive_periodic_frequent_itemsets";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/Visualize_ProdPer_frequent_itemsets.php";
	}
	...
	public String[] getInputFileTypes() {
		return new String[]{"Productive Periodic frequent itemsets"};
	}
