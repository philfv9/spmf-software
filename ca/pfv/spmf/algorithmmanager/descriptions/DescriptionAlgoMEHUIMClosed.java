...
/**
 * This class describes the MEHUIM-Closed algorithm parameters. It is designed to be used
 * by the graphical and command line interface.
 *
 * @see AlgoMEHUIMClosed
 * @author Hongyang Yang, Philippe Fournier-Viger
 */
public class DescriptionAlgoMEHUIMClosed extends DescriptionOfAlgorithm {

    /**
     * Default constructor
     */
    public DescriptionAlgoMEHUIMClosed() {
    }

    @Override
    public String getName() {
        return "MEHUIM-Closed";
    }
    ...
    public String getURLOfDocumentation() {
        return "http://www.philippe-fournier-viger.com/spmf/MEHUIM-Closed.php";
    }
    ...
    public String getImplementationAuthorNames() {
        return "Hongyang Yang, Philippe Fournier-Viger";
    }
    ...
    public String[] getOutputFileTypes() {
        return new String[] { "Patterns", "Closed patterns", "High-utility patterns", "Closed itemsets",
                "High-utility itemsets", "Closed high-utility itemsets" };
    }
