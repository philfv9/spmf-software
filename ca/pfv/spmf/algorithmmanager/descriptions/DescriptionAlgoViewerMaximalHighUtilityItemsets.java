 ...
 */
/**
 * This class describes the algorithm to visualize maximal high utility itemsets.
 * 
 * @see VisualPatternViewer
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoViewerMaximalHighUtilityItemsets extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoViewerMaximalHighUtilityItemsets(){
	}

	@Override
	public String getName() {
		return "Visualize_Maximal_High_Utility_itemsets";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/Visualize_Maximal_High_Utility_itemsets.php";
	}
	...
	public String[] getInputFileTypes() {
		return new String[]{"Maximal high-utility itemsets"};
	}
