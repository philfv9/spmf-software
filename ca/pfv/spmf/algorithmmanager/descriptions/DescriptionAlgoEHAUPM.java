...
/**
 * This class describes the EHAUPM algorithm parameters. It is designed to be
 * used by the graphical and command line interface.
 * 
 * @see AlgoApriori
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoEHAUPM extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoEHAUPM() {
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/EHAUPM.php";
	}
	...
	public void runAlgorithm(String[] parameters, String inputFile, String outputFile) throws IOException {
		...
		AlgoEHAUPM algo = new AlgoEHAUPM();
	...
	public DescriptionOfParameter[] getParametersDescription() {
		...
		parameters[0] = new DescriptionOfParameter("Minimum utility", "(e.g. 24)", Integer.class, false);
		return parameters;
	}
