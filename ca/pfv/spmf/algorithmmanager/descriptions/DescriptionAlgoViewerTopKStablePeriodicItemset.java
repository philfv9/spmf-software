 ...
 */
/**
 * This class describes the algorithm to visualize top-k stable periodic itemsets.
 * 
 * @see VisualPatternViewer
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoViewerTopKStablePeriodicItemset extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoViewerTopKStablePeriodicItemset(){
	}

	@Override
	public String getName() {
		return "Visualize_Top-K_Stable_periodic_itemsets";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/Visualize_TopKStablePeriodic.php";
	}
	...
	public String[] getInputFileTypes() {
		return new String[]{"Top-k Stable Periodic frequent itemsets"};
	}
