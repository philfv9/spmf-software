 ...
 */
/**
 * This class describes the algorithm to visualize high average utility itemsets.
 * 
 * @see VisualPatternViewer
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoViewerHighAverageUtilityItemsets extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoViewerHighAverageUtilityItemsets(){
	}

	@Override
	public String getName() {
		return "Visualize_High_Average_Utility_itemsets";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/Visualize_High_Average_Utility_itemsets.php";
	}
	...
	public String[] getInputFileTypes() {
		return new String[]{"High average-utility itemsets"};
	}
