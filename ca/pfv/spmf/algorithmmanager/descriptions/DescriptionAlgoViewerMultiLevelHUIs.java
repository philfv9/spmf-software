 ...
 */
/**
 * This class describes the algorithm to visualize multi-level high utility itemsets.
 * 
 * @see VisualPatternViewer
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoViewerMultiLevelHUIs extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoViewerMultiLevelHUIs(){
	}

	@Override
	public String getName() {
		return "Visualize_Multilevel_High_Utility_itemsets";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/Visualize_MultiLevelHUIs.php";
	}
	...
	public String[] getInputFileTypes() {
		return new String[]{"Multi-Level High-utility itemsets"};
	}
