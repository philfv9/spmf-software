...
/**
 * This class describes the DBVMiner algorithm parameters. It is designed to
 * be used by the graphical and command line interface.
 * 
 * @see AlgoDCharm_Bitset
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoDBVMiner extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoDBVMiner() {
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/DBVMiner.php";
	}
	...
	public void runAlgorithm(String[] parameters, String inputFile, String outputFile) throws IOException {
		...
		algo.runAlgorithm(outputFile, database, minsup);
		algo.printStats();
	}
