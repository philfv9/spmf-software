 ...
 */
/**
 * This class describes the algorithm to visualize high utility generator itemsets as in
 * the HUCI_Miner_Generators algorithm.
 * 
 * @see VisualPatternViewer
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoViewerGeneratorHighUtilityItemset extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoViewerGeneratorHighUtilityItemset(){
	}

	@Override
	public String getName() {
		return "Visualize_Generator_High_Utility_itemsets";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/Visualize_Gen_HUIs.php";
	}
	...
	public String[] getInputFileTypes() {
		return new String[]{"Generator high-utility itemsets"};
	}
