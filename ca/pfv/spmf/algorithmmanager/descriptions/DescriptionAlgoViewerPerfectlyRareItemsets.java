 ...
 */
/**
 * This class describes the algorithm to visualize perfectly rare itemsets.
 * 
 * @see VisualPatternViewer
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoViewerPerfectlyRareItemsets extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoViewerPerfectlyRareItemsets(){
	}

	@Override
	public String getName() {
		return "Visualize_Perfectly_rare_itemsets";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/Visualize_Perfectly_rare_itemsets.php";
	}
	...
	public String[] getInputFileTypes() {
		return new String[]{"Perfectly rare itemsets"};
	}
