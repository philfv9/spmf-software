...
import ca.pfv.spmf.algorithms.frequentpatterns.witfwi.AlgoWIT_FWI;
...
/**
 * This class describes the WIT-FWI algorithm parameters.
 * It is designed to be used by the graphical and command line interface.
 *
 * @see AlgoWIT_FWI
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoWIT_FWI extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoWIT_FWI(){
	}
	...
	public void runAlgorithm(String[] parameters, String inputFile, String outputFile) throws IOException {
		...
		// Applying the WIT-FWI algorithm
		AlgoWIT_FWI algorithm = new AlgoWIT_FWI();
