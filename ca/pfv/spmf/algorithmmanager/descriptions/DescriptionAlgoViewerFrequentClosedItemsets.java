 ...
 */
/**
 * This class describes the algorithm to visualize frequent closed itemsets.
 * 
 * @see VisualPatternViewer
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoViewerFrequentClosedItemsets extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoViewerFrequentClosedItemsets(){
	}

	@Override
	public String getName() {
		return "Visualize_Frequent_closed_itemsets";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/Visualize_Frequent_closed_itemsets.php";
	}
