...
/**
 * This class describes the UV-Eclat algorithm parameters. 
 * It is designed to be used by the graphical and command line interface.
 * 
 * @see AlgoUVEclat
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoUVEclat extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoUVEclat(){
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/UVEclat.php";
	}
	...
	public void runAlgorithm(String[] parameters, String inputFile, String outputFile) throws IOException {
		...
		AlgoUVEclat algorithm = new AlgoUVEclat(context);
