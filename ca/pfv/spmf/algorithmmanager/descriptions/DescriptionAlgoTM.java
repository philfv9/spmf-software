...
/**
 * This class describes the TM algorithm parameters. It is designed to be
 * used by the graphical and command line interface.
 * 
 * @see AlgoEclat
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoTM extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoTM() {
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/TM_itemset.php";
	}
