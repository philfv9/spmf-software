 ...
 */
/**
 * This class describes the algorithm to visualize frequent high utility itemsets.
 * 
 * @see VisualPatternViewer
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoViewerFrequentHighUtilityItemsets extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoViewerFrequentHighUtilityItemsets(){
	}

	@Override
	public String getName() {
		return "Visualize_Frequent_High_Utility_itemsets";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/Visualize_Frequent_High_Utility_itemsets.php";
	}
	...
	public String[] getInputFileTypes() {
		return new String[]{"Frequent high-utility itemsets"};
	}
