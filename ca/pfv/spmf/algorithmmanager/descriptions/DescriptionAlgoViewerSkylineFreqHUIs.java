 ...
 */
/**
 * This class describes the algorithm to visualize skyline frequent high utility
 * itemsets.
 * 
 * @see VisualPatternViewer
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoViewerSkylineFreqHUIs extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoViewerSkylineFreqHUIs() {
	}

	@Override
	public String getName() {
		return "Visualize_Skyline_frequent_HUIs";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/Visualize_Skyline_frequent_HUIs.php";	}
	...
	public String[] getInputFileTypes() {
		return new String[] { "Skyline Frequent High-utility itemsets" };
	}
