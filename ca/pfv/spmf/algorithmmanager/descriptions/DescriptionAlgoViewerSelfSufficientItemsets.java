 ...
 */
/**
 * This class describes the algorithm to visualize self-sufficient itemsets.
 * 
 * @see VisualPatternViewer
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoViewerSelfSufficientItemsets extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoViewerSelfSufficientItemsets(){
	}

	@Override
	public String getName() {
		return "Visualize_Self_sufficient_itemsets";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/Visualize_Self_sufficient_itemsets.php";
	}
	...
	public String[] getInputFileTypes() {
		return new String[]{"Self-Sufficient Itemsets"};
	}
