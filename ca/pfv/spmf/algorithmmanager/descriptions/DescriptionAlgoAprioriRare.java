...
/**
 * This class describes the AprioriRareFast algorithm parameters. 
 * It is designed to be used by the graphical and command line interface.
 * 
 * @see AprioriClose
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoAprioriRare extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoAprioriRare(){
	}
	...
	public void runAlgorithm(String[] parameters, String inputFile, String outputFile) throws IOException {
		...
		// apply the algorithm
		apriori2.runAlgorithm(minsup, inputFile, outputFile, 30);
		apriori2.printStats();
	}
