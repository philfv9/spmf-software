...
/**
 * This class describes the WFIM algorithm parameters.
 * It is designed to be used by the graphical and command line interface.
 *
 * @see AlgoWFIM
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoWFIM extends DescriptionOfAlgorithm {

    /**
     * Default constructor.
     */
    public DescriptionAlgoWFIM() {
    }
    ...
    public String getURLOfDocumentation() {
        return "http://www.philippe-fournier-viger.com/spmf/WFIM.php";
    }
    ...
    public void runAlgorithm(String[] parameters, String inputFile, String outputFile)
        ...
        double minSupRatio        = getParamAsDouble(parameters[1]);
        double minWeight          = getParamAsDouble(parameters[2]);
        ...
        AlgoWFIM algorithm = new AlgoWFIM();
        algorithm.runAlgorithm(inputFile, weightsPath, outputFile, minSupRatio, minWeight);
    ...
    public DescriptionOfParameter[] getParametersDescription() {
        ...
        parameters[1] = new DescriptionOfParameter("Min support ratio",
                "(e.g. 0.40 or 40%)", Double.class, false);
        parameters[2] = new DescriptionOfParameter("Min weight",
                "(e.g. 0.5)", Double.class, false);
        return parameters;
    }
