 ...
 */
/**
 * This class describes the algorithm to visualize rare correlated itemsets
 * common to multiple sequences.
 * 
 * @see VisualPatternViewer
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoViewerRareCorrelatedItemsetsMultiSeq extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoViewerRareCorrelatedItemsetsMultiSeq() {
	}

	@Override
	public String getName() {
		return "Visualize_Rare_correlated_itemsets_MultiSequences";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/Visualize_RareCoreMultiSeq.php";
	}
	...
	public String[] getInputFileTypes() {
		return new String[] { "Rare correlated itemsets common to multiple sequences" };
	}
