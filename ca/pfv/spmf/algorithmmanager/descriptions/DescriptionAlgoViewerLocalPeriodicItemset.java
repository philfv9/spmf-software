 ...
 */
/**
 * This class describes the algorithm to visualize local periodic frequent itemsets.
 * 
 * @see VisualPatternViewer
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoViewerLocalPeriodicItemset extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoViewerLocalPeriodicItemset(){
	}

	@Override
	public String getName() {
		return "Visualize_Local_periodic_frequent_itemsets";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/Visualize_LocalPerItemsets.php";
	}
	...
	public String[] getInputFileTypes() {
		return new String[]{"Local Periodic frequent itemsets"};
	}
