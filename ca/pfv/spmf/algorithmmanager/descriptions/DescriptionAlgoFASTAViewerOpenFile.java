...
/**
 * This class describes the algorithm to run the FASTA file viewer of SPMF.
 *
 * @see FastaViewer
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoFASTAViewerOpenFile extends DescriptionOfAlgorithm {

    /**
     * Default constructor.
     */
    public DescriptionAlgoFASTAViewerOpenFile() {
    }

    @Override
    public String getName() {
        return "Open_FASTA_file_with_viewer";
    }
    ...
    public String getURLOfDocumentation() {
        return "http://www.philippe-fournier-viger.com/spmf/FASTA_basic_viewer.php";
    }
