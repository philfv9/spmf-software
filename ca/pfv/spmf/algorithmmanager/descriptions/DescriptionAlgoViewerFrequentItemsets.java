 ...
 */
public class DescriptionAlgoViewerFrequentItemsets extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoViewerFrequentItemsets(){
	}

	@Override
	public String getName() {
		return "Visualize_Frequent_itemsets";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/View_frequent_itemsets.php";
	}
