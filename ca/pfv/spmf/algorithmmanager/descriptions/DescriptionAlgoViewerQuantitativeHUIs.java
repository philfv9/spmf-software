 ...
 */
/**
 * This class describes the algorithm to visualize quantitative high utility itemsets.
 * 
 * @see VisualPatternViewer
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoViewerQuantitativeHUIs extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoViewerQuantitativeHUIs(){
	}

	@Override
	public String getName() {
		return "Visualize_Quantitative_high_Utility_itemsets";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/Visualize_quantitative_huis.php";
	}
	...
	public String[] getInputFileTypes() {
		return new String[]{"Quantitative high utility itemsets"};
	}
