...
import ca.pfv.spmf.algorithms.frequentpatterns.efim.AlgoIMEFIM;
...
/**
 * This class describes the MEFIM algorithm parameters. It is designed to be
 * used by the graphical and command line interface.
 * 
 * @see AlgoIMEFIM
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoMEFIM extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoMEFIM() {
	}
	...
	public void runAlgorithm(String[] parameters, String inputFile, String outputFile) throws IOException {
		...
		AlgoIMEFIM algo = new AlgoIMEFIM();
