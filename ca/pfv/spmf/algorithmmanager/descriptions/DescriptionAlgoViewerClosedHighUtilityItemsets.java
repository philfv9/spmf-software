 ...
 */
/**
 * This class describes the algorithm to visualize closed high utility itemsets.
 * 
 * @see VisualPatternViewer
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoViewerClosedHighUtilityItemsets extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoViewerClosedHighUtilityItemsets(){
	}

	@Override
	public String getName() {
		return "Visualize_Closed_High_Utility_itemsets";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/Visualize_Closed_High_Utility_itemsets.php";
	}
	...
	public String[] getInputFileTypes() {
		return new String[]{"Closed high-utility itemsets"};
	}
