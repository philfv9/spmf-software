 ...
 */
/**
 * This class describes the algorithm to visualize frequent weighted itemsets.
 * 
 * @see VisualPatternViewer
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoViewerFrequentWeightedItemsets extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoViewerFrequentWeightedItemsets(){
	}

	@Override
	public String getName() {
		return "Visualize_Frequent_Weighted_Itemsets";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/Visualize_Frequent_Weighted_Itemsets.php";
	}
