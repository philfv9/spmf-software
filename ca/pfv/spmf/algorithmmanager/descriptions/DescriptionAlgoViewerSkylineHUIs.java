 ...
 */
public class DescriptionAlgoViewerSkylineHUIs extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoViewerSkylineHUIs() {
	}

	@Override
	public String getName() {
		return "Visualize_Skyline_HUIs";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/Visualize_Skyline_HUIs.php";	}
	...
	public String[] getInputFileTypes() {
		return new String[] { "Skyline High-utility itemsets" };
	}
