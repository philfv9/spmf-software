 ...
 */
/**
 * This class describes the algorithm to visualize periodic high utility itemsets.
 * 
 * @see VisualPatternViewer
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoViewerPeriodicHighUtilityItemsets extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoViewerPeriodicHighUtilityItemsets(){
	}

	@Override
	public String getName() {
		return "Visualize_Periodic_High_Utility_itemsets";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/Visualize_High_Periodic_Utility_itemsets.php";
	}
	...
	public String[] getInputFileTypes() {
		return new String[]{"Periodic high-utility itemsets"};
	}
