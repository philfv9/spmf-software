...
/**
 * This class describes the GENMAXZ algorithm parameters. It is designed to be
 * used by the graphical and command line interface.
 * 
 * @see AlgoGENMAX
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoGenMax extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoGenMax() {
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/GENMAX_maximal.php";
	}

	@Override
	public void runAlgorithm(String[] parameters, String inputFile, String outputFile) throws IOException {
		double minsup = getParamAsDouble(parameters[0]);
		AlgoGENMAX algo = new AlgoGENMAX();
