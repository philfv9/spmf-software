...
/**
 * This class describes the META algorithm parameters.
 * It is designed to be used by the graphical and command line interface.
 * 
 * @see AlgoMETA
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoMETA extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoMETA() {
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/META.php";
	}
	...
	public String[] getInputFileTypes() {
		return new String[]{"Database of instances", "Transaction database",
				"Transaction database with profit information"};
	}
