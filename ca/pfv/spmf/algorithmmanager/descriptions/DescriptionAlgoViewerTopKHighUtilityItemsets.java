 ...
 */
public class DescriptionAlgoViewerTopKHighUtilityItemsets extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoViewerTopKHighUtilityItemsets(){
	}

	@Override
	public String getName() {
		return "Visualize_Top-K_High_Utility_itemsets";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/Visualize_Top-K_High_Utility_itemsets.php";
	}
	...
	public String[] getInputFileTypes() {
		return new String[]{"Top-k High-utility itemsets"};
	}
