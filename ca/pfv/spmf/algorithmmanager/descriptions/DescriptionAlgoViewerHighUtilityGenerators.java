 ...
 */
/**
 * This class describes the algorithm to visualize high utility generator itemsets.
 * 
 * @see VisualPatternViewer
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoViewerHighUtilityGenerators extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoViewerHighUtilityGenerators(){
	}

	@Override
	public String getName() {
		return "Visualize_High_Utility_Generators";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/Visualize_High_Utility_Generators.php";
	}
	...
	public String[] getInputFileTypes() {
		return new String[]{"High-utility generator itemsets"};
	}
