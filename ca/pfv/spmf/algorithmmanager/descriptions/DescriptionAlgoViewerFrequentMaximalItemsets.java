 ...
 */
/**
 * This class describes the algorithm to visualize frequent maximal itemsets.
 * 
 * @see VisualPatternViewer
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoViewerFrequentMaximalItemsets extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoViewerFrequentMaximalItemsets(){
	}

	@Override
	public String getName() {
		return "Visualize_Frequent_maximal_itemsets";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/Visualize_Frequent_maximal_itemsets.php";
	}
	...
	public String[] getInputFileTypes() {
		return new String[]{"Frequent maximal itemsets"};
	}
