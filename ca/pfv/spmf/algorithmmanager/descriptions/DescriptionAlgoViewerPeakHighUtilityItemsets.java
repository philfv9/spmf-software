 ...
 */
public class DescriptionAlgoViewerPeakHighUtilityItemsets extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoViewerPeakHighUtilityItemsets(){
	}

	@Override
	public String getName() {
		return "Visualize_Peak_high_Utility_itemsets";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/Visualize_peak.php";
	}
	...
	public String[] getInputFileTypes() {
		return new String[]{"Peak high-utility itemsets"};
	}
