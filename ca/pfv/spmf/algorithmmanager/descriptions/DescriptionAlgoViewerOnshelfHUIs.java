 ...
 */
/**
 * This class describes the algorithm to visualize onshelf high utility itemsets.
 * 
 * @see VisualPatternViewer
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoViewerOnshelfHUIs extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoViewerOnshelfHUIs(){
	}

	@Override
	public String getName() {
		return "Visualize_Onshelf_High_Utility_itemsets";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/Visualize_OnshelfHUIs.php";
	}
	...
	public String[] getInputFileTypes() {
		return new String[]{"On-shelf high-utility itemsets"};
	}
