...
import ca.pfv.spmf.algorithms.frequentpatterns.NFWI.AlgoNFWI;
...
*/
/**
 * This class describes the NFWI algorithm parameters.
 * It is designed to be used by the graphical and command line interface.
 *
 * @see AlgoNFWI
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoNFWI extends DescriptionOfAlgorithm {

    /**
     * Default constructor.
     */
    public DescriptionAlgoNFWI() {
    }
    ...
    public String getURLOfDocumentation() {
        return "http://www.philippe-fournier-viger.com/spmf/NFWI.php";
    }
    ...
    public void runAlgorithm(String[] parameters, String inputFile, String outputFile)
        ...
        AlgoNFWI algorithm = new AlgoNFWI();
