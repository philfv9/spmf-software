 ...
 */
/**
 * This class describes the algorithm to visualize frequent generator itemsets.
 * 
 * @see VisualPatternViewer
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoViewerFrequentGeneratorItemsets extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoViewerFrequentGeneratorItemsets(){
	}

	@Override
	public String getName() {
		return "Visualize_Frequent_generator_itemsets";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/Visualize_Frequent_generator_itemsets.php";
	}
	...
	public String[] getInputFileTypes() {
		return new String[]{"Frequent generator itemsets"};
	}
