 ...
 */
/**
 * This class describes the algorithm to visualize cross-level high utility itemsets.
 * 
 * @see VisualPatternViewer
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoViewerCrossLevelHighUtilityItemsets extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoViewerCrossLevelHighUtilityItemsets(){
	}

	@Override
	public String getName() {
		return "Visualize_Crosslevel_High_Utility_itemsets";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/Visualize_CrossLevelHUIs.php";
	}
	...
	public String[] getInputFileTypes() {
		return new String[]{"Cross-Level High-utility itemsets"};
	}
