...
import ca.pfv.spmf.algorithms.frequentpatterns.NFWI.AlgoNFWCI;
...
*/
/**
 * This class describes the NFWCI algorithm parameters.
 * It is designed to be used by the graphical and command line interface.
 *
 * @see AlgoNFWCI
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoNFWCI extends DescriptionOfAlgorithm {

    /**
     * Default constructor.
     */
    public DescriptionAlgoNFWCI() {
    }
    ...
    public String getURLOfDocumentation() {
        return "http://www.philippe-fournier-viger.com/spmf/NFWCI_CLOSED.php";
    }
    ...
    public void runAlgorithm(String[] parameters, String inputFile,
        ...
        AlgoNFWCI algorithm = new AlgoNFWCI();
        algorithm.runAlgorithm(inputFile, weightsPath, outputFile,
                minWeightedSupport);
    ...
    public String[] getInputFileTypes() {
        return new String[]{"Transaction database",
