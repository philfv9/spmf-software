 ...
 */
/**
 * This class describes the algorithm to visualize minimal rare itemsets.
 * 
 * @see VisualPatternViewer
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoViewerFrequentMinimalRareItemsets extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoViewerFrequentMinimalRareItemsets(){
	}

	@Override
	public String getName() {
		return "Visualize_Minimal_rare_itemsets";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/Visualize_Minimal_rare_itemsets.php";
	}
	...
	public String[] getInputFileTypes() {
		return new String[]{"Minimal rare itemsets"};
	}
