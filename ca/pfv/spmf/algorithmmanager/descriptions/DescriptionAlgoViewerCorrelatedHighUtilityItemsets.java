 ...
 */
/**
 * This class describes the algorithm to visualize correlated high utility itemsets.
 * 
 * @see VisualPatternViewer
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoViewerCorrelatedHighUtilityItemsets extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoViewerCorrelatedHighUtilityItemsets(){
	}

	@Override
	public String getName() {
		return "Visualize_Correlated_High_Utility_itemsets";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/Visualize_Correlated_High_Utility_itemsets.php";
	}
	...
	public String[] getInputFileTypes() {
		return new String[]{"Correlated High-utility itemsets"};
	}
