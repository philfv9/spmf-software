...
/**
 * This class describes parameters of the PNAR(Eclat) algorithm for generating positive
 ...
 */
public class DescriptionAlgoPNAREclat extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoPNAREclat(){
	}
