...
/**
 * This class describes the dMERIT+ algorithm parameters. 
 * It is designed to be used by the graphical and command line interface.
 * 
 * @see AlgoDMERIT
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoDMERIT extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoDMERIT(){
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/dMERITPlus.php";
	}
