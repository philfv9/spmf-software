 ...
 */
/**
 * This class describes the algorithm to visualize periodic frequent itemsets.
 * 
 * @see VisualPatternViewer
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoViewerPeriodicFrequentItemsets extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoViewerPeriodicFrequentItemsets(){
	}

	@Override
	public String getName() {
		return "Visualize_Periodic_frequent_itemsets";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/Visualize_Periodic_frequent_itemsets.php";
	}
	...
	public String[] getInputFileTypes() {
		return new String[]{"Periodic frequent itemsets"};
	}
