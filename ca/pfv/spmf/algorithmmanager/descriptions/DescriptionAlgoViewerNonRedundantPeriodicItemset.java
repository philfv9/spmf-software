 ...
 */
/**
 * This class describes the algorithm to visualize non redundant periodic itemsets.
 * 
 * @see VisualPatternViewer
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoViewerNonRedundantPeriodicItemset extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoViewerNonRedundantPeriodicItemset(){
	}

	@Override
	public String getName() {
		return "Visualize_Nonredundant_Periodic_itemsets";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/Visualize_NonRedundantPeriodic.php";
	}
	...
	public String[] getInputFileTypes() {
		return new String[]{"Non-redundant Periodic frequent itemsets"};
	}
