 ...
 */
/**
 * This class describes the Uncertain frequent itemset Viewer algorithm to visualize uncertain frequent itemsets.
 * 
 * @see VisualPatternViewer
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoViewerUncertainFrequentItemsets extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoViewerUncertainFrequentItemsets(){
	}

	@Override
	public String getName() {
		return "Visualize_Uncertain_frequent_itemsets";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/Visualize_Uncertain_frequent_itemsets.php";
	}
	...
	public String[] getInputFileTypes() {
		return new String[]{"Uncertain frequent itemsets"};
	}
