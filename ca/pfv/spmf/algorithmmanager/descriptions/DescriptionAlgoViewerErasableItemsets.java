 ...
 */
/**
 * This class describes the algorithm to visualize erasable itemsets.
 * 
 * @see VisualPatternViewer
 * @author Philippe Fournier-Viger
 */
public class DescriptionAlgoViewerErasableItemsets extends DescriptionOfAlgorithm {

	/**
	 * Default constructor
	 */
	public DescriptionAlgoViewerErasableItemsets(){
	}

	@Override
	public String getName() {
		return "Visualize_Erasable_itemsets";
	}
	...
	public String getURLOfDocumentation() {
		return "http://www.philippe-fournier-viger.com/spmf/Visualize_Erasable_itemsets.php";
	}
	...
	public String[] getInputFileTypes() {
		return new String[]{"Erasable itemsets"};
	}
