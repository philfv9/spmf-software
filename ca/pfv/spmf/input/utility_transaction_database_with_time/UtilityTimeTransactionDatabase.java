 ...
 *
 * @see AlgoTwoPhase
 * @see TransactionTimeUtility
 * @author Philippe Fournier-Viger
 */
public class UtilityTimeTransactionDatabase {
	...
	private final List<TransactionTimeUtility> transactions = new ArrayList<TransactionTimeUtility>();
...
//					System.out.println(stringValue);
	...
	private void processTransaction(String[] line) {
		...
		Integer timestamp = Integer.parseInt(line[3]);
		...
		transactions.add(new TransactionTimeUtility(itemUtilityObjects, transactionUtility, timestamp));
	}
	...
	public void printDatabase() {
		...
		for (TransactionTimeUtility itemset : transactions) {
	 ...
	 */
	public List<TransactionTimeUtility> getTransactions() {
		return transactions;
	}
