...
/**
 * Example of how to use APRIORI-RARE (simple version) and save the output to a file,
 * from the source code.
 * @author Philippe Fournier-Viger (Copyright 2008)
 */
public class MainTestAprioriRare_Simple_saveToFile {
	...
	public static String fileToPath(String filename) throws UnsupportedEncodingException{
		URL url = MainTestAprioriRare_Simple_saveToFile.class.getResource(filename);
