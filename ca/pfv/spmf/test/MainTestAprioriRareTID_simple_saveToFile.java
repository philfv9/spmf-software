...
/**
 * Example of how to use APRIORI-RARE (***simple*** TID version) and save the output to a file,
 ...
 */
public class MainTestAprioriRareTID_simple_saveToFile {
	...
	public static String fileToPath(String filename) throws UnsupportedEncodingException{
		URL url = MainTestAprioriRareTID_simple_saveToFile.class.getResource(filename);
