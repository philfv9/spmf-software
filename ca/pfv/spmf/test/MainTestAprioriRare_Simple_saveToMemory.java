...
/**
 * Example of how to use the APRIORI RARE (simple version) algorithm, from the source code.
 * @author Philippe Fournier-Viger (Copyright 2008)
 */
public class MainTestAprioriRare_Simple_saveToMemory {
	...
	public static String fileToPath(String filename) throws UnsupportedEncodingException{
		URL url = MainTestAprioriRare_Simple_saveToMemory.class.getResource(filename);
