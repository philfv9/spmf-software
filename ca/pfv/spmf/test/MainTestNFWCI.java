...
*/
/**
 * Example of how to use the NFWCI algorithm from the source code.
 *
 * @see AlgoNFWCI
 * @author Philippe Fournier-Viger
 */
public class MainTestNFWCI {
    ...
    public static String fileToPath(String filename)
        ...
        URL url = MainTestNFWCI.class.getResource(filename);
