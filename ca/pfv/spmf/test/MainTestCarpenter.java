...
/**
 * Example of how to use the Carpenter algorithm from the source code to mine closed itemsets.
 * 
 ...
 */
public class MainTestCarpenter {
	...
	public static void main(String[] args) throws IOException {
		...
		// patterns.
		boolean keepOnlyMaximalPatterns = false;
	...
	public static String fileToPath(String filename) throws UnsupportedEncodingException {
		URL url = MainTestCarpenter.class.getResource(filename);
