...
import ca.pfv.spmf.algorithms.frequentpatterns.merit.AlgoMERIT;

/**
 * Example of how to use the MERIT+ algorithm in source code.
 *
 * @author Philippe Fournier-Viger
 */
public class MainTestMERIT {

    /**
     * Main method to run the MERIT+ algorithm on a sample product database.
     *
    ...
    public static void main(String[] arg) throws NumberFormatException, IOException {
        ...
        // apply the MERIT+ algorithm
        AlgoMERIT algo = new AlgoMERIT();
    ...
    public static String fileToPath(String filename) throws UnsupportedEncodingException {
        URL url = MainTestMERIT.class.getResource(filename);
