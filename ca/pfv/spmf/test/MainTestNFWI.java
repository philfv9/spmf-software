...
/**
 * Example of how to use the NFWI algorithm from the source code.
 *
 * @see AlgoNFWI
 * @author Philippe Fournier-Viger
 */
public class MainTestNFWI {
    ...
    public static String fileToPath(String filename) throws UnsupportedEncodingException {
        URL url = MainTestNFWI.class.getResource(filename);
