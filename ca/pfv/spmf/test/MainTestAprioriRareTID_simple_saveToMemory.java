...
/**
 * Example of how to use the APRIORI RARE algorithm (TID **simple** version), from the source code.
 ...
 */
public class MainTestAprioriRareTID_simple_saveToMemory {
	...
	public static String fileToPath(String filename) throws UnsupportedEncodingException{
		URL url = MainTestAprioriRareTID_simple_saveToMemory.class.getResource(filename);
