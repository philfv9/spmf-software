...
import ca.pfv.spmf.algorithms.frequentpatterns.talkyg.AlgoTalkyG_Bitset;
...
/**
 * Example of how to use TalkyG algorithm from the source code.
 * @author Philippe Fournier-Viger
 */
public class MainTestTalkyG_saveToFile {
	...
	public static void main(String [] arg) throws IOException{
		...
		AlgoTalkyG_Bitset algo = new AlgoTalkyG_Bitset();
		...
		algo.runAlgorithm(output, database, minsup, useTriangularMatrixOptimization, hashTableSize);
		algo.printStats();
	}
	
	public static String fileToPath(String filename) throws UnsupportedEncodingException{
		URL url = MainTestTalkyG_saveToFile.class.getResource(filename);
