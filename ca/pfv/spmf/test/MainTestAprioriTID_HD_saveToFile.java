...
import ca.pfv.spmf.algorithms.frequentpatterns.aprioriTID.AlgoAprioriTID_HD;

/**
 * Example of how to use APRIORI-TID_HD and save the output to a file,
 * from the source code.
 * 
 * @author Philippe Fournier-Viger 
 */
public class MainTestAprioriTID_HD_saveToFile {
...
//		algo.setShowTransactionIdentifiers(true);
	...
	public static String fileToPath(String filename) throws UnsupportedEncodingException{
		URL url = MainTestAprioriTID_HD_saveToFile.class.getResource(filename);
