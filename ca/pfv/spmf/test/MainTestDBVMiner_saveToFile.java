...
/**
 * Example of how to use DBVMiner algorithm from the source code with results
 * save to a file.
 * 
 * @author Philippe Fournier-Viger - 2025
 */
public class MainTestDBVMiner_saveToFile {
...
//		algo.setShowTransactionIdentifiers(true);
	...
	public static String fileToPath(String filename) throws UnsupportedEncodingException {
		URL url = MainTestDBVMiner_saveToFile.class.getResource(filename);
