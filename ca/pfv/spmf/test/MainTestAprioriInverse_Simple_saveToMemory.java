...
/**
 * Example of how to use the APRIORI-INVERSE (simple version) algorithm from the source
 * code.
 * 
 * @author Philippe Fournier-Viger (Copyright 2008)
 */
public class MainTestAprioriInverse_Simple_saveToMemory {
	...
	public static String fileToPath(String filename) throws UnsupportedEncodingException{
		URL url = MainTestAprioriInverse_Simple_saveToMemory.class.getResource(filename);
