...
/**
 * Example of how to use the AprioriInverse (simple version) algorithm and save the output
 * to a file, from the source code.
 * 
 * @author Philippe Fournier-Viger (Copyright 2008)
 */
public class MainTestAprioriInverse_Simple_saveToFile {
	...
	public static String fileToPath(String filename) throws UnsupportedEncodingException{
		URL url = MainTestAprioriInverse_Simple_saveToFile.class.getResource(filename);
