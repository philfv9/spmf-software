...
/**
 * Convert a transaction database with utility information to a transaction
 * database without utility values from the source code.
 * 
...
public class TransactionUtilityRemover {
	 ...
	 * without utility values from the source code.
	 * 
	 * @param input  the input file path (a transaction database with utility values
	 *               in SPMF format)
