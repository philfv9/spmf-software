...
/**
 * This tool increment the id of items in a transaction database by a given
 * number (e.g. 1). This is useful for example, when a database contain the item
 * "0". The item "0" is not allowed by some algorithm. So using this tool we can
 * fix that.
 * 
